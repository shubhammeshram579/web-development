  ...
  return (
    ...
    <>
      <div id="homePageContainer" className="relative z-50">
        ...
        <div id="hpHeading"  className="butn bg-yellow-200 relative z-40 pb-6 pt-2">
        ...
        >
          <div id="hpagecard" >
            ...
            <div id="Dinertext" className="absolute z-50 bg-white text-black font-bold py-8 px-20 text-2xl rounded-full ml-28">
              <h1>
        ...
        <div id="hpage3" className="page2 flex items-center justify-around h-[100vh] w-full pt-32 bg-teal-200">
          <div className="card1">
          ...
          <div id="imgCard" className="card2 flex items-center justify-center gap-20">
            <div className="card1 flex items-center justify-between gap-[140px] flex-col ">
              <h1 id="bgimg1" className="bg-[url(https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aG9tZXxlbnwwfHwwfHx8MA%3D%3D)] h-[500px] w-[500px] rounded-3xl bg-center bg-cover font-semibold text-6xl pt-[40%] text-white text-center brightness-90">
            ...
            <div className="card2 flex items-center justify-between gap-20 flex-col">
              ...
              <h1 id="bgimg2" className="bg-[url(https://images.unsplash.com/photo-1534196511436-921a4e99f297?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8bXklMjBkcmVhbXN8ZW58MHx8MHx8fDA%3D)] h-[200px] w-[200px] mr-32 rounded-3xl bg-center bg-cover font-semibold text-xl pt-24 text-white brightness-90">
        ...
        <div id="hpage4" className="page3 h-[100vh]  w-full flex justify-between gap-20">
        ...
        <div id="hpage5" className="page4 pb-10">
          <img id="hp5img" className="w-full min-h-[100vh] absolute z-10" src={img2} alt="" />
          <div id="bghpage5Card" className="absolute z-20 bg-gray-950 opacity-75 h-[100vh] w-full"></div>
          <div id="hpage5Card" className="relative z-50 flex items-center justify-between px-80">
            <div id="hp5text" className="card ">
              ...
              <h1 id="Ideatext" className="font-semibold text-6xl text-white text-start">
                ideas
              </h1>
            </div>
        ...
        <div id="HomepageFooter" className="w-full mt-24 flex items-center justify-center">
          <Footer />
        </div>
      </div>
    </>
